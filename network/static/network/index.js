  ...
  fetch(`new?page=${no}`)
    ...
    .then(poss=>{
      ...
      poss.forEach((post)=>{
        ...
        <textarea class="form-control" id="compose-body${post.id}" placeholder="Edit" class="d-flex align-items-center justify-content-left" >${post.body}</textarea>
        <input type="submit" class="btn btn-primary d-flex align-items-center justify-content-left"/>
    </form>`;
